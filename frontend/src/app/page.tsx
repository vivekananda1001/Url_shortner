...
export default function Home(){
  ...
  async function loginHandler(): Promise<void> {
      try{
        await axios.post<SignInResponse>("http://localhost:3000/api/signin",{
          email,
          password
        });
    ...
    <div className="bg-gray-300 flex justify-center items-center h-screen">
      <div className="bg-white m-2 p-8 rounded-lg min-w-[23%] flex flex-col">
        ...
        <div className="text-2xl mt-5 font-bold flex flex-col">
            ...
            <div className="text-sm font-normal text-blue-500 flex justify-end px-2 hover:cursor-pointer hover:underline">
              Forgot Password?
            </div>
            <button 
            ...
            <div className="text-sm font-normal mt-2 flex">
              ...
              <Link href="/signup">
                <div className="ml-1 underline hover:cursor-pointer">Create one</div>
              </Link>
            </div>
        </div>
      </div>
